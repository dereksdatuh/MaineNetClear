...
(function () {
  ...
  var STARTUP_ITEMS = [
    ...
    { id: 'su-trailer',    name: 'Utility Trailer (used 6x12 or 7x14)', notes: 'Facebook Marketplace Maine. Big Tex or Sure-Trac, prioritize ramp gate.', cat: 'Equipment &amp; Vehicle', lean: 1500, std: 3500 },
    { id: 'su-trailerreg', name: 'Trailer Registration (Maine)',        notes: 'Annual. Verify trailer GVWR vs. tow rating.',                cat: 'Equipment &amp; Vehicle', lean: 35,   std: 55 },
  ...
  var CHECKLIST = [
    ...
    {
      week: 'Week 2: Equipment &amp; Identity',
      items: [
        { id: 'cl-6',  text: 'Source and purchase utility trailer', cost: '$1,500-3,500', time: 'Variable' },
        { id: 'cl-7',  text: 'Register trailer with Maine BMV', cost: '$35-55', time: '1 hr' },
