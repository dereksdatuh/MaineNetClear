...
(function () {
  ...
  var STARTUP_ITEMS = [
    ...
    { id: 'su-wiring',     name: 'Trailer Wiring Harness Adapter',      notes: 'Check for a 4-pin or 7-pin plug near the receiver first. Factory tow package usually has it pre-wired; if not, plug-and-play Curt/Tekonsha harness, no splicing.', cat: 'Equipment &amp; Vehicle', lean: 0, std: 60 },
    { id: 'su-brakectrl',  name: 'Trailer Brake Controller',            notes: 'Required if trailer GVWR &gt; 3,000 lbs and it has electric brakes (Maine law). Check the trailer\'s GVWR sticker on the tongue before skipping this.', cat: 'Equipment &amp; Vehicle', lean: 0, std: 120 },
  ...
  var CHECKLIST = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'cl-6b', text: 'Check for factory 4/7-pin wiring plug near the receiver; install adapter harness if missing, then test lights/brakes/turn signals', cost: '$0-60', time: '30-60 min' },
        { id: 'cl-6c', text: 'If trailer GVWR &gt; 3,000 lbs with electric brakes, install in-cab brake controller', cost: '$0-120', time: '1-2 hrs (or shop install)' },
